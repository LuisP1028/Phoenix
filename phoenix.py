...
# -------------------- Configuration --------------------
####### Eli Live is a legacy model.
# ['High', 'Low', 'Close', 'agg_buy_sell_ratio']

# Paths
DATA_FILE_PATH = "C:/Users/Chopp/Desktop/3.csv"  # Replace with your actual file path
BEST_HYPERPARAMS_FILE = 'configs/eliLIVE_hyperparameters.json'
TRAINED_MODEL_FILE = 'models/eliLive.keras'  # Updated file extension to .keras
PLOT_OUTPUT_FILE = 'plots/elilivemodel_performance.png'
